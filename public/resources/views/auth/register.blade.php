...
<div class="col-md-3 text-center" style="margin:0 auto;">
  <form method="POST" action="{{route('register_invitation')}}">
    ...
    <div class="col-md-6 form-group text-center">
      <input type="date" required placeholder="custom_field_2" class="form-control form-control-lg text-center" id="custom_field_2" name="custom_field_2" min="1970-01-01" value="{{ old('custom_field_2') or '1970-01-01' }}">
      @if($errors->any())
