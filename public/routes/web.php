...
Auth::routes();
    ...
    Route::middleware(['auth','admin'])->prefix('admin')->group(function () {
        ...
        Route::get('/guest/import', 'InvitationController@import')->name('invitation.import');
        Route::post('/guest/import', 'InvitationController@process_import')->name('invitation.process_import');
